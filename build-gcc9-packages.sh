...
_copy_data_to_repo mingw-w64-i686-gcc9 mingw-w64-i686-gcc9-libs && \
MINGW_ARCH="mingw64" makepkg-mingw -sLf --skippgpcheck && \
_copy_data_to_repo mingw-w64-x86_64-gcc9 mingw-w64-x86_64-gcc9-libs && \
MINGW_ARCH="ucrt64" makepkg-mingw -sLf --skippgpcheck && \
_copy_data_to_repo mingw-w64-ucrt-x86_64-gcc9 mingw-w64-ucrt-x86_64-gcc9-libs
