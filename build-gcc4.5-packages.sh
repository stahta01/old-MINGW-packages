...
cd mingw-w64-gcc4.5-static && \
export SOURCE_DATE_EPOCH=$(git log -1 --pretty=%ct -- PKGBUILD) && \
MINGW_ARCH="mingw32" makepkg-mingw -Lf && \
_copy_data_to_repo mingw-w64-i686-gcc4.5-static mingw-w64-i686-gcc4.5 mingw-w64-i686-gcc4.5-libs && \
MINGW_ARCH="mingw64" makepkg-mingw -Lf && \
_copy_data_to_repo mingw-w64-x86_64-gcc4.5-static mingw-w64-x86_64-gcc4.5 mingw-w64-x86_64-gcc4.5-libs
